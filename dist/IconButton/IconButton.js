...
const _excluded = ["className", "description"];
...
const IconButton = /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  ...
  return /*#__PURE__*/_react.default.createElement(_core.Button, _extends({
    ...
    className: (0, _clsx.default)(_IconButtonModule.default.button, className, description && _IconButtonModule.default.tooltip)
  }));
});
